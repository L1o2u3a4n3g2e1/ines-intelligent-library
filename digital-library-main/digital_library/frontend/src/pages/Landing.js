...
export default function Landing() {
  ...
  const handleGuestContinue = async () => {
    ...
    try {
      ...
      setGuestError(error.message || t('guestError'));
    } finally {
            ...
            <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}>
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <motion.button
                  ...
                  {guestLoading ? t('connecting') : `${t('guestSendCode')} ->`}
                </motion.button>
              </div>
              ...
              <div className="relative w-full max-w-sm">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={i} className="bg-brand-50 rounded-2xl p-3 flex items-center gap-3">
                        <div className="w-9 h-12 rounded-lg bg-gradient-to-br from-brand-200 to-brand-500 flex items-center justify-center text-white text-lg flex-shrink-0"><FiBookOpen size={20} /></div>
                ...
                <motion.div animate={{ y: [-4, 4, -4] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}
                  ...
                  <div className="flex items-center gap-2">
                    <FiHeadphones size={12} className="text-brand-600 flex-shrink-0" />
                    <p className="text-xs font-semibold text-brand-600 m-0">Audio Ready</p>
                  </div>
                </motion.div>
                <motion.div animate={{ y: [4, -4, 4] }} transition={{ duration: 3.5, repeat: Infinity, ease: 'easeInOut' }}
                  ...
                  <div className="flex items-center gap-2">
                    <FiGlobe size={12} className="text-brand-600 flex-shrink-0" />
                    <p className="text-xs font-semibold text-brand-600 m-0">EN & RW</p>
                  </div>
                </motion.div>
              </div>
            </motion.div>
