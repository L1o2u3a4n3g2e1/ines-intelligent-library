<?php
/**
 * INES Digital Library - verified book importer.
 *
 * Safe by default:
 ...
 * - Uses the real INES schema in database/database.sql.
 */
...
function db(): PDO
{
    ...
    $name = getenv('DB_NAME') ?: 'ines_intelligent_library';
...
try {
    log_message('=== INES verified book import: ' . ($dryRun ? 'DRY RUN' : 'EXECUTE') . ' ===');
