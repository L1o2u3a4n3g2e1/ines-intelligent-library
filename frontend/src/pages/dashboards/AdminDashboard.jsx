...
export default function AdminDashboard() {
  ...
  return (
    <>
      ...
      <DashboardBrand title="Welcome to INES Digital Library" description="Manage the institutional catalog, academic structure, verification, and library operations." />
