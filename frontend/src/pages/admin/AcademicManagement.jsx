...
export default function AcademicManagement() {
  ...
  return (
    <>
      <PageHeader title="Faculties and departments" description="Maintain the official INES academic structure used for catalog filtering and field-specific recommendations." />
